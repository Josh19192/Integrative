...
function inject($database)
{
    ...
    if (isset($_GET['id'])) {
        ...
        $record = $database->getDataById('child_info', $record_id); // You need to implement this method in your database class
    }

?>
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Add Shot /</span> Inject</h4>
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <h2><span class="fw-bold py-3 mb-4">Add Shot</span></h2>
                            </a>
                        </div>
                        <br>
                        <form method="POST" action="home.php?tab=shot_records">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select" name="vaccineName" id="vaccineName" required>
                                        ...
                                        foreach ($vaccineNames as $vaccineName) {
                                            echo '<option value="' . $vaccineName['id'] . '">' . $vaccineName['vaccine_name'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="remarks" name="remarks" rows="4" placeholder="Write remarks..."></textarea>
                                </div>
                            </div>

                            <div class="mt-2" style="text-align: center;">
                                <button type="submit" name="shot" onclick="showMessageBox()" class="btn btn-primary me-2" style="width: 60%; text-align:center;background-color:#1b1a5e;margin-top:3%">Save</button>
                            </div>
